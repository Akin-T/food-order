...
const MenuItem = () => {
    return (
        <div className="bg-secondary rounded-3xl">
            <div className="w-full bg-[#f1f2f3] h-[210px] grid place-content-center rounde-bl-[46px] rounded-tr-2xl">
                <div className="relative w-36 h-36 z-36 hover:scale-110 transition-all">
